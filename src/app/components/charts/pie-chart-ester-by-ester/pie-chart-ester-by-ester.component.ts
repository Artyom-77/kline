...
@Component({
  ...
  templateUrl: './pie-chart-ester-by-ester.component.html',
  styleUrls: ['./pie-chart-ester-by-ester.component.scss'],
})
export class PieChartEsterByEsterComponent implements OnInit {
  @Input() chartData?: any;
